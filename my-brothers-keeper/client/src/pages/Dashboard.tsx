      ...
      <div className="min-h-screen bg-background noise-texture relative">
        ...
        <div className="relative p-8 space-y-8">
          ...
          {isPrimaryOrAdmin && pendingUsers.length > 0 && (
            <Card className="card-elevated-lg accent-bar-orange relative border-primary/50 bg-primary/5">
              <CardHeader>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="card-elevated hover-lift accent-bar-teal relative">
            ...
            <Card className="card-elevated hover-lift accent-bar-teal relative">
              ...
              <CardContent>
                <div className="text-3xl font-bold">{openNeeds.length}</div>
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
              <Link href="/needs">
                <Card className="card-elevated hover-lift cursor-pointer">
                  <CardHeader>

...
- **Family Name Font**: Cinzel serif with large cap first letters and small caps for remaining letters (text-3xl, bold, wide tracking) in brand teal (#2DB5A8) to match logo text style

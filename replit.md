...
- **Glass System**:
  ...
  - **Sidebar**: `background: rgba(255, 255, 255, 0.85)` with `backdrop-filter: blur(30px)` - almost opaque white with heavy frosting, dark teal text
...
- **Glassmorphism Architecture**:
  ...
  - **Sidebar**: `rgba(255, 255, 255, 0.85)` with 30px blur - almost opaque white with heavy frosting, dark teal text (`text-teal-700`)

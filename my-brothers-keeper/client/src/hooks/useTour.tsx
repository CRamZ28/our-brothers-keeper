    ...
    <Joyride
      ...
      styles={{
        options: {
          ...
          arrowColor: "rgba(255, 255, 255, 0.88)",
          zIndex: 10000,
        },
        tooltip: {
          borderRadius: "20px",
          ...
          borderImage: "linear-gradient(135deg, rgba(176, 140, 167, 0.3), rgba(45, 181, 168, 0.2)) 1",
          boxShadow: "0 12px 40px rgba(176, 140, 167, 0.12), inset 0 1px 0 rgba(255, 255, 255, 0.9)",
          maxWidth: "600px",
          minWidth: "400px",
        },
        tooltipContainer: {

    ...
    <DashboardLayout>
      <GlassPageLayout
        title={
          ...
          >
            <span className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl">E</span>
            <span>VENTS</span>
          </span>
        }
        actions={
                ...
                <div className="space-y-4">
                  {pastEvents.map((event) => (
                    <GlassCard key={event.id} className="opacity-75">
                      <CardHeader>
                        <CardTitle className="text-base sm:text-lg overflow-hidden line-clamp-2">{event.title}</CardTitle>
                        <CardDescription>

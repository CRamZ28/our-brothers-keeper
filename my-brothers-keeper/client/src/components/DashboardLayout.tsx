...
const menuItems = [
  ...
  { icon: Heart, label: "Needs Board", path: "/needs" },
  ...
  return (
    <>
      <div className="relative" ref={sidebarRef}>
        <Sidebar
          collapsible="icon"
          className="border-r bg-[#6BC4B8]/5"
                    ...
                    <SidebarMenuItem key={item.path}>
                      <SidebarMenuButton
                        ...
                        className={`h-10 transition-all font-normal ${
                          isActive 
                            ? "bg-[#6BC4B8]/10 hover:bg-[#6BC4B8]/15 border-l-2 border-[#6BC4B8]" 
                            : "hover:bg-accent"
                        }`}
                      >
                        <item.icon
                          className={`h-4 w-4 shrink-0 ${isActive ? "text-[#6BC4B8]" : ""}`}
                        />
      ...
      <SidebarInset>
        {isMobile && (
          <div className="flex border-b h-14 items-center justify-between bg-sidebar/95 px-2 backdrop-blur supports-[backdrop-filter]:backdrop-blur sticky top-0 z-40 border-sidebar-border">

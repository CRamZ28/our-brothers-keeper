  ...
  create: protectedProcedure
    .input(
      z.object({
        ...
        eventType: z.enum(["regular", "birthday", "anniversary", "milestone", "holiday"]).default("regular"),
  ...
  update: protectedProcedure
    .input(
      z.object({
        ...
        endAt: z.date().optional(),
        eventType: z.enum(["regular", "birthday", "anniversary", "milestone", "holiday"]).optional(),
